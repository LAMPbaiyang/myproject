                    ...
                    <div class="logo_box">
                        ...
                        <form action="{{url('homes/login')}}"  method="post">
                            ...
                            <div class="input_outer">
                                ...
                                <input name="name" class="text" style="color: #FFFFFF !important" type="text" placeholder="请输入账户名称">
                            </div>
                            <div class="input_outer">
							...
							<div class="mb2">
								<a href="{{url('homes/register')}}"><span class="act-but submit"  style="color: #FFFFFF">还没有账号?点击注册</span></a>
							</div>
