...
<div class="movielist" id="movie_list">
  <ul class="clearfix">
    ...
    <a href="{{url('play')}}" class="movie_img">
     <img src="/qiantai/video/d1.jpg"  width="183px;"/>
     <span class="v_title">
    ...
    <a href="#" class="movie_img">
     <img src="/qiantai/video/d5.jpg"  width="183px;"/>
     <span class="v_title">
      <em>更新至24集</em><i class="fraction">4.5分</i>
     </span>
    </a>
    ...
    <a href="#" class="movie_img">
     <img src="/qiantai/video/d2.jpg"  width="183px;"/>
     <span class="v_title">
      <em>更新至24集</em><i class="fraction">4.5分</i>
     </span>
    </a>
    ...
    <a href="#" class="movie_img">
     <img src="/qiantai/video/d3.jpg"  width="183px;"/>
     <span class="v_title">
      <em>更新至24集</em><i class="fraction">4.5分</i>
     </span>
    </a>
    <div class="movie_title">
     ...
     <i class="icon_b rb_ico"></i>
    <a href="#" class="movie_img">
     <img src="/qiantai/video/d4.jpg"  width="183px;"/>
     <span class="v_title">
      <em>更新至24集</em><i class="fraction">4.5分</i>
     </span>
    </a>
    ...
    <div class="movie_title">
     ...
     <i class="icon_b rb_ico"></i>
    <a href="#" class="movie_img">
     <img src="/qiantai/video/d9.jpg"  width="183px;"/>
     <span class="v_title">
      <em>更新至24集</em><i class="fraction">4.5分</i>
     </span>
    </a>
    <div class="movie_title">
     ...
     <i class="icon_b rb_ico"></i>
    <a href="#" class="movie_img">
     <img src="/qiantai/video/d8.jpg"  width="183px;"/>
     <span class="v_title">
      <em>更新至24集</em><i class="fraction">4.5分</i>
     </span>
    </a>
    <div class="movie_title">
     ...
     <i class="icon_b rb_ico"></i>
    <a href="#" class="movie_img">
     <img src="/qiantai/video/d7.jpg"  width="183px;"/>
     <span class="v_title">
      <em>更新至24集</em><i class="fraction">4.5分</i>
     </span>
    </a>
    <div class="movie_title">
     ...
     <i class="icon_b rb_ico"></i>
    <a href="#" class="movie_img">
     <img src="/qiantai/video/d6.jpg"  width="183px;"/>
     <span class="v_title">
      <em>更新至24集</em><i class="fraction">4.5分</i>
     </span>
    </a>
