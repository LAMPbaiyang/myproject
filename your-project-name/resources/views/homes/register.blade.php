...
<div class="register-container">
  ...
  <form action="{{url('homes/doregister')}}"  method="post" id="registerForm">
    ...
    <div>
      <input type="text" name="name" class="name" placeholder="请输入用户名" oncontextmenu="return false" onpaste="return false" value="{{old('name')}}" />
    </div>
    <div>
      <input type="password" name="password" class="password" placeholder="输入密码" oncontextmenu="return false" onpaste="return false" value="{{old('password')}}" />
    </div>
    ...
    <div>
      <input type="text" name="phone_number" class="phone_number" placeholder="请输入您的手机号" autocomplete="off" id="number" value="{{old('phone_number')}}"/>
    </div>
