...
<title>登录注册</title>
<link rel="stylesheet" href="/qiantai/center/register/css/style.css" />
<body>
...
<script src="/qiantai/center/register/js/jquery-1.8.3.min.js"></script>
<script src="/qiantai/center/register/js/common.js')}}"></script>
<!--背景图片自动更换-->
<script src="/qiantai/center/register/js/supersized.3.2.7.min.js"></script>
<script src="/qiantai/center/register/js/supersized-init.js"></script>
<!--表单验证-->
<script src="/qiantai/center/register/js/jquery.validate.min.js?var1.14.0"></script>
...
//    alert(phone_number);
        $.post('{{url('homes/yanzhengma')}}',{'phone':phone_number,'_token':'{{csrf_token()}}'},function(data){
            console.log(data);
