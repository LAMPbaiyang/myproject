                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-border-form tpl-form-border-br" action="{{url('admin/ad_user')}}" method='post'>
                                {{ csrf_field() }}
                              <!--   {{ method_field('PUT') }} -->
                                    <div class="am-form-group">
                                     ...
                                     <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" name="tel" id="user-name" placeholder="请输入您的昵称">    
                                        </div>
                                    </div>
