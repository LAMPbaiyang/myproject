            ...
            <div class="container-fluid am-cf">
                <div class="row">
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
                        <div class="page-header-heading"><span class="am-icon-home page-header-heading-icon"></span> 编辑用户 </div>
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-border-form tpl-form-border-br" action="{{url('admin/ad_user/'.$info->uid)}}" method='post'>
                              ...
                              <!--   {{ method_field('PUT') }} -->
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" name="tel"   id="user-name" placeholder="{{$info->tel}}">
                                           
                                        </div>
                                    </div>
                                    
                                     <div class="am-form-group">
                                        <label for="user-name" name="nickName" class="am-u-sm-3 am-form-label">用户昵称 <span class="tpl-form-line-small-title">uname</span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" name="uname" id="user-name" placeholder="{{$info->uname}}">    
                                        </div>
                                    </div>
