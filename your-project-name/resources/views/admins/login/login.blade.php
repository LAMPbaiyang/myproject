    ...
    <div class="am-g tpl-g">
        ...
        <div class="tpl-login">
            <div class="tpl-login-content">
                ...
                <form class="am-form tpl-form-line-form" action="{{url('admins/login')}}" method="post">
				{{csrf_field()}}
                    ...
                    <div class="am-form-group">
                        <input type="password" class="tpl-form-input" name="upass" id="user-pass" placeholder="请输入密码">
