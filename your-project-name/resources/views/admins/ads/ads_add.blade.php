                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form action="{{url('admins/ads')}}" method="post" class="am-form tpl-form-border-form tpl-form-border-br" id="art_form" onsubmit="check()">
								{{csrf_field()}}
									   ...
									   <div class="am-u-sm-9">
											<div class="am-form-group am-form-file">
												<div class="tpl-form-file-img">
													...
													<p><img src="{{asset('houtai/img/a5.png')}}" id="img1" style="width:400px"></p>
												</div>
