                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form action="{{url('admins/ads/'.$info->ad_id)}}" method="post" class="am-form tpl-form-border-form tpl-form-border-br" id="art_form">
								...
								{{csrf_field()}}
									   ...
									   <div class="am-u-sm-9">
											<div class="am-form-group am-form-file">
												<!-- <div class="tpl-form-file-img"> -->
													<input type="text" name="ad_pic" id="art_thumb"  value="{{$info->ad_pic}}" disabled>
													
												<!--	<input name="file_upload" id="file_upload" type="file" value="" disabled>  
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="ad-name" name="ad_name" value="{{$info->ad_name}}"  placeholder="请输入轮播图名称">
									...
									<div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <textarea class="" rows="10" class="tpl-form-input" name="ad_content" id="user-name" value="" placeholder="{{$info->ad_content}}"></textarea>
