...
<script src="/houtai/texiao/js/jquery.min.js"></script>
...
<script src="/houtai/texiao/js/typed.min.js"></script>
...
<div class="buttons">
  ...
  <button onClick="colorChange(colors[1][0], colors[1][1])">Blue
</button>
</div>
<div id="typedStrings">
  <p>你好</p>
...
colorChange(initialColor);</script>
