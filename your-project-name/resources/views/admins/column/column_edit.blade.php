            ...
            <div class="container-fluid am-cf">
                <div class="row">
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
                        <div class="page-header-heading"><span class="am-icon-home page-header-heading-icon"></span> 修改栏目</div>
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">修改栏目表单</div>
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-border-form tpl-form-border-br" action="{{url('admins/column/'.$info->vid)}}" method='post'>
								<input type="hidden" name="_method" value="put">
                                {{ csrf_field() }}
                              <!--   {{ method_field('PUT') }} -->
                                    <div class="am-form-group">
                                        <label for="user-name" class="am-u-sm-3 am-form-label">栏目名称<span class="tpl-form-line-small-title">tel</span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" name="cname"   id="user-tel" value="{{$info->cname}}" placeholder="">
                                     ...
                                     <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" name="vname" id="user-name" value="{{$info->vname}}" placeholder="">    
                                        </div>
                                    </div>
