...
<head>
    ...
    <!-- stylesheets -->
    <link rel="stylesheet" href="homes/a/css/font-awesome.css">
    <link rel="stylesheet" href="/d/css/style.css">
    <!-- google fonts  -->
    <link href="homes/a/css/bx.css" rel="stylesheet">
    <link href="/a/css/bd.css" rel="stylesheet">
</head>
<body>
        ...
        <div class="wrapper">
            ...
            <div class="w3ls-form">
                <form action="/" method="post">
                    ...
                    <a href="#" class="pass" style="text-align:left">忘记密码</a>
                    
                    <input type="submit" value="登录" />
                    <a href="zc" class="pass" style="text-align:right" >立即注册</a>
                </form>
            </div>
        </div>
        <br>
